...
This directory contains Agent Team Playbook integrations and converted formats for
supported agentic coding tools.

## Supported Tools

- **[OpenClaw agents](#claude-code)** — `.md` agents, use the repo directly
...
Agent Team Playbook was originally designed for OpenClaw agents. Agents work natively
without conversion.
...
Agent Team Playbook also works natively with GitHub Copilot. Agents can be copied
